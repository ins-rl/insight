...
sam_args = {
    ...
    # 'model_type': "vit_h",
    # 'sam_checkpoint': "ckpt/mobile_sam.pt",
    # 'model_type': "vit_t",
    'generator_args':{
        'points_per_side': 16,
        'pred_iou_thresh': 0.8,
...
segtracker_args = {
    ...
    'min_area': 100, # minimal mask area to add a new mask as a new object
    'max_area': 1000000, # minimal mask area to add a new mask as a new object
